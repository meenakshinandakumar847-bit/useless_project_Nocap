...
const gapNumber =
    document.getElementById("gapNumber");
const gapFill =
    document.getElementById("gapFill");
const gapMessage =
    document.getElementById("gapMessage");
const gapEmoji =
    document.getElementById("gapEmoji");
const ageNumber =
    document.getElementById("ageNumber");
const ageMessage =
    document.getElementById("ageMessage");
const homeScreen =
...
const modeIntro =
    document.getElementById("modeIntro");
const originalText =
    document.getElementById("originalText");
const levelSlider =
    document.getElementById("levelSlider");
const levelNumber =
...
const modeAge =
    document.getElementById("modeAge");
const modeAgeMessage =
    document.getElementById("modeAgeMessage");
const exitQuestion =
    document.getElementById("exitQuestion");
const copyBtn =
    document.getElementById("copyBtn");
const backBtn =
    document.getElementById("backBtn");
const sitBtn =
    document.getElementById("sitBtn");
const exitModeBtn =
    document.getElementById("exitModeBtn");
const toast =
